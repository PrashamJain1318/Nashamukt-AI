  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Weekly Report */}
        <Card className="p-6 col-span-1 lg:col-span-2 bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20">
        ...
        {/* Motivation */}
        <Card className="p-6 bg-card border-border flex flex-col justify-center text-center">
        ...
        <Card className="p-6 bg-card border-border">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl font-bold text-green-500">₹{data.risk.projectedSavings.toLocaleString()}</p>
            </div>
            <div>
        ...
        <Card className="p-6 bg-card border-border">
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-sm text-muted-foreground mb-1">Identified Triggers</p>
              <div className="flex flex-wrap gap-2">
                {data.mood.triggersIdentified.map((t: string, i: number) => (
                  <span key={i} className="px-2 py-1 bg-secondary rounded-md text-xs font-medium">{t}</span>
                ))}
              </div>
            </div>
